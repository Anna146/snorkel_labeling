...
t0 = time.time()
if args.load_posts:
    process_reddit_post_csv("/home/tigunova/profession_post_" + p + "/part-00000", prefix = p)
elif args.label_posts:
    label_post("/home/tigunova/PycharmProjects/snorkel_labels/data/profession/raw_train_posts_" + p + ".pkl", prefix = p)
elif args.load_users:
    process_reddit_user_raw("/home/tigunova/profession_user_" + p + "/part-00000", prefix = p)
elif args.group_posts:
    merge_post_df("/home/tigunova/PycharmProjects/snorkel_labels/data/profession/train_post_" + p + ".pkl", prefix = p)
elif args.join:
    join_post_author("/home/tigunova/PycharmProjects/snorkel_labels/data/profession/processed_train_post_" + p + ".pkl", "/home/tigunova/PycharmProjects/snorkel_labels/data/profession/train_authors_" + p + ".pkl", prefix = p)
elif args.label_users:
    label_user("/home/tigunova/PycharmProjects/snorkel_labels/data/profession/joint_post_author_" + p + ".pkl", prefix = p)
